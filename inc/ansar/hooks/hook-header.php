...
<div class="mg-head-detail hidden-xs">
    <div class="container-fluid">
        <div class="row">
            ...
            $newsup_header_vk_link = get_theme_mod('newsup_header_vk_link');
            $newsup_header_vk_target = esc_attr(get_theme_mod('newsup_header_vk_target','true'));
            ...
            <div class="col-md-6 col-xs-12">
                <ul class="mg-social info-right">
                      ...
                      <?php } ?>
                      <?php if($newsup_header_vk_link !=''){ ?>
                      <a <?php if($newsup_header_vk_target) { ?> target="_blank" <?php } ?>href="<?php echo esc_url($newsup_header_vk_link); ?>">
                      <li><span class="icon-soci vk"><i class="fa fa-vk"></i></span> </li></a>
                      <?php } ?>
